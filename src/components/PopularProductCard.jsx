const PopularProductCard = ({ imgUrl, name, price }) => {
	return (
		<div className="flex flex-1 flex-col items-center justify-center w-full max-sm:w-full">
			<img
				role="presentation"
				src={imgUrl}
				alt={name}
				className="w-[320px] h-[320px] bg-gradient-to-t from-[#ff8147] to-[#FFD700] rounded-2xl"
			/>
			...
			<div className="mt-8 flex justify-start gap-2.5">
				...
				<span className="font-montserrat text-xl leading-normal text-white-400">
					(4.5)
				</span>
			</div>
			<h3 className="mt-2 text-2xl leading-normal font-palanquin font-semibold text-white-400">
				{name}
			</h3>
			<p className="mt-2 font-montserrat  text-2xl font-semibold bg-gradient-to-r from-[#ff6347] to-[#FFD700] bg-clip-text w-fit text-transparent leading-normal">
				{price}
			</p>
		</div>
	);
